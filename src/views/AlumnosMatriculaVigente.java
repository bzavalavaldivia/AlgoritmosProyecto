...
public class AlumnosMatriculaVigente extends JInternalFrame {
	...
	public static void main(String[] args) {
		try {
//			AlumnosMatriculaVigente frame = new AlumnosMatriculaVigente();
//			frame.setVisible(true);
	 ...
	 * Create the dialog.
	 */
	public AlumnosMatriculaVigente() {
		...
		JLabel lblNewLabel = new JLabel("Alumnos con matr\u00EDcula vigente");
